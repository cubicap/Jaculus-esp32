...
struct GridUiWidgetSlider : public jac::ProtoBuilder::Opaque<gridui::Slider>, public jac::ProtoBuilder::Properties {
    static void addProperties(JSContext* ctx, jac::Object proto) {
        ...
        proto.defineProperty("setColor", ff.newFunctionThis([](jac::ContextRef ctx, jac::ValueWeak thisVal, std::string color) {
            auto& w = *GridUiWidgetSlider::getOpaque(ctx, thisVal);
            w.setColor(color);
